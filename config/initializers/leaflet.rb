#Leaflet.tile_layer = "/mouse_guard_tiles/{z}/{x}/{y}.png"
...
Leaflet.attribution = "Jykke ref: http://www.cartographersguild.com/finished-maps/11075-mouse-guard-map-facelift.html"
Leaflet.max_zoom = 18